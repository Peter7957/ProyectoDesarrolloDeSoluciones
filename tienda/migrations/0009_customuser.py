...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tienda', '0008_rename_nombre_aro_aro_rename_nombre_genero_genero'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.CharField(choices=[('admin', 'Admin'), ('cliente', 'Cliente'), ('Bodeguero', 'Bodeguero')], max_length=15)),
